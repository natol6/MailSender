...
namespace WpfTest.ViewModels
{
    class DBConnectMailSender
    {
        ...
        public DBConnectMailSender()
        {
            db.Database.EnsureCreated();
        }
        public IEnumerable<Account> DbGetAccounts()
        {
            return db.Accounts.ToArray();
        }
        public IEnumerable<MailService> DbGetMailServices()
        {
            return db.MailServices.ToArray();
        }
